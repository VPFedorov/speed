...
#include <cctype>
using namespace std;
////////////////класс OrderInputScreen////////////////////
//класс OrderInputScreen. Ёто класс, отвечающий за отображение Ђэкранаї,
...
public:
	OrderInputScreen(OrderList* ptrTL)/*, string sh, string cons, int num, int mont, int day, float pr) */: ptrOrderList(ptrTL)//, ship(sh), cons(cons), num(num), month(month), pr(pr)*/
	{
		/* тут пусто */
	}
